package software.reloadly.sdk.billpay.operation;
...
public class BaseBillpayOperation extends BaseOperation {

    BaseBillpayOperation(HttpUrl baseUrl, String apiToken, OkHttpClient client) {
    ...
    protected <T> Request<T> createGetRequest(String url, TypeReference<T> type) {
        ...
        request.addHeader(HttpHeader.ACCEPT, Version.BILLPAY_V1.getValue());
    ...
    protected <T> Request<T> createPostRequest(String url, Object body, TypeReference<T> type) {
        return new CustomRequest<>(client, url, "POST", type)
                .addHeader(HttpHeader.ACCEPT, Version.BILLPAY_V1.getValue())
